...
class WebpackOptionsApply extends OptionsApply {
	...
	process(options, compiler) {
		...
		if (moduleIds === undefined) {
			// TODO webpack 5 remove all these options id:13
		...
		if (moduleIds) {
			switch (moduleIds) {
				case "natural":
					// TODO webpack 5: see hint in Compilation.sortModules id:56
					break;
				case "named":
		...
		if (chunkIds === undefined) {
			// TODO webpack 5 remove all these options id:79
			if (options.optimization.occurrenceOrder) {
		...
		if (chunkIds) {
			switch (chunkIds) {
				case "natural":
					...
					break;
				case "named":
					// TODO webapck 5: for backward-compat this need to have OccurrenceChunkOrderPlugin too id:102
