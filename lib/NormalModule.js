...
class NormalModule extends Module {
	constructor({
		...
		// TODO refactor this -> options object filled from Factory id:12
	...
	createLoaderContext(resolver, options, compilation, fs) {
		...
		const loaderContext = {
			...
			// TODO remove in webpack 5 id:55
			exec: (code, filename) => {
	...
	createSource(source, resourceBuffer, sourceMap) {
		...
		if (Buffer.isBuffer(source)) {
			// @ts-ignore
			// TODO We need to fix @types/webpack-sources to allow RawSource to take a Buffer | string id:78
			return new RawSource(source);
		}
	...
	getHashDigest(dependencyTemplates) {
		// TODO webpack 5 refactor id:101
