...
/** @typedef {{module: Module, loc: TODO , request: string}} OriginRecord id:22*/
...
class ChunkGroup {
	...
	getChildrenByOrders() {
		...
		for (const childGroup of this._children) {
			// TODO webpack 5 remove this check for options id:3
		...
		for (const [name, list] of lists) {
			list.sort((a, b) => {
				...
				if (cmp !== 0) return cmp;
				// TODO webpack 5 remove this check of compareTo id:46
