...
class WebpackOptionsDefaulter extends OptionsDefaulter {
	constructor() {
		...
		// TODO webpack 5 add `moduleIds: "named"` default for development id:33
		// TODO webpack 5 add `moduleIds: "size"` default for production id:14
		// TODO webpack 5 remove optimization.occurrenceOrder id:57
		...
		// TODO webpack 5 remove optimization.namedModules id:80
		this.set(
		...
		// TODO webpack 5 add `chunkIds: "named"` default for development id:103
		// TODO webpack 5 add `chunkIds: "size"` default for production id:34
		// TODO webpack 5 remove optimization.namedChunks id:15
		this.set(
		...
		this.set("optimization.nodeEnv", "make", options => {
			// TODO: In webpack 5, it should return `false` when mode is `none` id:58
