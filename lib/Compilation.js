...
class Compilation extends Tapable {
	...
	constructor(compiler) {
		...
		this.hooks = {
			...
			/** @type {SyncWaterfallHook<string, TODO >} id:23*/
			assetPath: new SyncWaterfallHook(["filename", "data"]), // TODO MainTemplate id:4
			...
			// TODO the following hooks are weirdly located here id:47
			// TODO move them for webpack 5 id:70
		...
		// TODO refactor this in webpack 5 to a custom DependencyTemplates class with a hash property id:93
		// @ts-ignore
	...
	addEntry(context, entry, name, callback) {
		const slot = {
			name: name,
			// TODO webpack 5 remove `request` id:24
			request: null,
			module: null
		};
		...
		// TODO webpack 5: merge modules instead when multiple entry modules are supported id:5
	 ...
	 */
	sortModules(modules) {
		// TODO webpack 5: this should only be enabled when `moduleIds: "natural"` id:48
		// TODO move it into a plugin (NaturalModuleIdsPlugin) and use this in WebpackOptionsApply id:71
		// TODO remove this method id:94
	...
	getDependencyReference(module, dependency) {
		// TODO remove dep.getReference existence check in webpack 5 id:25
	...
	processDependenciesBlocksForChunkGroups(inputChunkGroups) {
		...
		const iteratorBlock = b => {
			...
			if (c === undefined) {
				...
				// TODO webpack 5 remove addOptions check id:6
	 ...
	 * @param {DependenciesBlockLike} block //TODO: good description id:49
	 * @returns {void}
	 */
...
// TODO remove in webpack 5 id:72
...
// TODO remove in webpack 5 id:95
