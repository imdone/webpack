...
// TODO webpack 5: pos must be SourcePosition id:106
/**
...
const formatPosition = pos => {
	if (pos === null) return "";
	// TODO webpack 5: Simplify this id:37
	...
	if (typeof pos === "object") {
		if ("line" in pos && "column" in pos) {
			...
			// TODO webpack 5 remove this case id:18
			return `+${pos.index}`;
		} else {
			return "";
		}
...
// TODO webpack 5: loc must be DependencyLocation id:61
/**
...
const formatLocation = loc => {
	if (loc === null) return "";
	// TODO webpack 5: Simplify this id:84
