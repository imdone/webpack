			...
			(compilation, { normalModuleFactory }) => {
				...
				compilation.hooks.optimizeChunkModules.tap(
					...
					(chunks, modules) => {
						...
						// HACK: Sort configurations by length and start with the longest one id:112
						// to get the biggers groups possible. Used modules are marked with usedModules
						// TODO: Allow to reuse existing configuration while trying to add dependencies. id:62
						...
						for (const concatConfiguration of concatConfigurations) {
							...
							// TODO: remove when LTS node version contains fixed v8 version id:85
