	...
	getChildIdsByOrders() {
		...
		for (const group of this.groupsIterable) {
			if (group.chunks[group.chunks.length - 1] === this) {
				for (const childGroup of group.childrenIterable) {
					// TODO webpack 5 remove this check for options id:44
		...
		for (const [name, list] of lists) {
			list.sort((a, b) => {
				...
				if (cmp !== 0) return cmp;
				// TODO webpack 5 remove this check of compareTo id:67
...
// TODO remove in webpack 5 id:90
...
// TODO remove in webpack 5 id:21
...
// TODO remove in webpack 5 id:45
...
// TODO remove in webpack 5 id:68
...
// TODO remove in webpack 5 id:91
